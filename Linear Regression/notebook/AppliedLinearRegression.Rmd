...
# Os autores construíram um testes global (conjunto) para quatro suposições. Um dos objetivos é evitar um erro do tipo I grande que pode acontecer quando realizamos os testes separados.
