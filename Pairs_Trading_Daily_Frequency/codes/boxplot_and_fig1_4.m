...
set(h, 'Interpreter', 'tex','FontSize',7);
ylabel('Annualized Return (%)','FontSize', 12);
xlabel('Opening Threshold','FontSize', 12);
title('Sensitivity Analysis on Committed Capital','FontSize', 11);
grid on
...
ylabel('Annualized Return (%)','FontSize', 12);
xlabel('Opening Threshold','FontSize', 12);
title('Sensitivity Analysis on Fully Invested Capital','FontSize', 11);
grid on
...
ylabel('Cumulative Excess Return');
xlabel('Year');
title('(a) Top 5 pairs, Fully Invested, after costs');
grid on
...
ylabel('Cumulative Excess Return');
xlabel('Year');
title('(a) Top 20 pairs, Committed Capital, after costs');
grid on
...
ylabel('Cumulative Excess Return');
xlabel('Year');
title('(a) Top 20 pairs, Fully Invested, after costs');
grid on
...
ylabel('Cumulative Excess Return');
xlabel('Year');
title('(a) Top 35 pairs, Committed Capital, after costs');
grid on
...
ylabel('Cumulative Excess Return');
xlabel('Year');
title('(a) Top 35 pairs, Fully Invested, after costs');
grid on
