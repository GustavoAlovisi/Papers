...
%
% Input:
% pfoReturns: matrix where each column is a return series
% for a single portfolio
% Output:
% maxDrawdowns: row vector of maximum drawdowns for each
% portfolio
% =============================================================
function maxDrawdowns = maxdrawdown(pfoReturns)
% Total number of periods and number of portfolios in the
% input data
