...
% Ja tenho os retornos no banco de dados # Rt

%rodar a funcao probSearch com a euclidiana encapsulada
[otimo, compOpt, pesosOpt] = probSearch(Rt,@euclidiana,10,1000);
...
ret_par1 = Rt(:,compOpt(1:quant_acoes/2))*pesosOpt;

%retornos do portoflio 2
ret_par2 = Rt(:,compOpt(1+quant_acoes/2:end))*pesosOpt;
