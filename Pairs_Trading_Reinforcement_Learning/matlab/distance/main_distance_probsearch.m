...
% Não chequei se o código está selecionando os retornos corretos daqui para
% baixo. Talvez tenha que trocar min_SSE_ro, min_SSE_co por stock. Talvez
% esteja pegando os corretos. Tem que abrir a matriz de dados e checar.
