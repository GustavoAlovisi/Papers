...
#####
## DISCOVER URL'S OF ALL FOMC MINUTES AVAILABLE
#####

main.page = read_html(x = "https://www.federalreserve.gov/monetarypolicy/fomccalendars.htm")
...
# <select name="from_year" id="yearselect" alt="From: Select a Year">
#   <option value='1936' selected>1936</option>
#     <option value='1937'>1937</option>
#       
#       </select> &nbsp;&nbsp; Through: <select name="to_month" id="monthselect2"
#       alt="Through: Select a Month">
#         <option value='1'>Jan</option>
#         <option value='2' selected>Feb</option>
#         
#         </select> <select name="to_year" id="yearselect2"
#       alt="Through: Select a Year">
#         
#         <p class="">
#         
#         <strong><a href="https://www.federalreserve.gov/monetarypolicy/fomcminutes20121212.htm" >
#         
#         <p class="">
#         
#         <strong><a href="https://www.federalreserve.gov/monetarypolicy/fomcminutes20120801.htm" >
#         <p class="">
#         
#         <strong><a href="https://www.federalreserve.gov/fomc/minutes/20070321.htm" >
#         
#         <p class="">
#         
#         <strong><a href="https://www.federalreserve.gov/fomc/minutes/20000321.htm" >
#         
# Collect price data e.g. Treasury yields or S&P500 and do some visual
# / initial exploratory analysis around the FOMC announcement dates
# As a first step in visualizing/exploring the data from my last post, 
# FOMC Dates - Scraping Data From Web Pages, 
# I'll plot the FOMC announcement dates along with the following price series: 
#   2-Year and 10-Year US Treasury yields, S&P500 ETF (SPY) and USD Index ETF (UUP).
...
download.file(
  "https://docs.google.com/uc?export=download&id=0B4oNodML7SgSMlZxYW4yWTZabGs",
  "fomcdatesall.csv", "curl")
