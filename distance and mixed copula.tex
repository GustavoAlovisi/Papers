...
\begin{figure}[H]
	...
	%\includegraphics[width=\linewidth,height=7.5cm]{fig26.pdf}
		\resizebox{\linewidth}{!}{\input{fig26.tex}}
...
%	\includegraphics[width=\linewidth,height=7.5cm]{fig42.pdf}
	\resizebox{\linewidth}{!}{\input{fig42.tex}}
	\captionsetup{justification=raggedright,
		singlelinecheck=false
	}
...
%	\footnote{Mom is the average return on two (big and small) high prior return portfolios minus the average return on the two low prior return portfolios
	...
	The main purpose of these regressions is to estimate the intercept alpha - the average excess return not explained by these factors. The errors have been adjusted for heteroscedasticity and autocorrelation by using Newey-West adjustment with six lags.
...
The main findings are summarized below.
	...
	\item The mixed copula strategy is able to generate a higher mean excess return and a Sharpe ratio over twice as much as what we get from investing in the tradicional distance method after trading costs when the number of trading signals is equiparable.
